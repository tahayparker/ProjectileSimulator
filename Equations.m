%{
    given initial velocity, angle of launch, initial height, and acceleration write equations to find final position, coordinates at max height, max distance, and time of flight. 
%}
